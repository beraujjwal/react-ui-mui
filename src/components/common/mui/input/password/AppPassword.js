  ...
  (
    {
      ...
      sx = {},
      iconProps = {},
      ...restOfProps // includes value, onChange, error, helperText, disabled, etc.
    },
    ref
  ) => {
    const [showPassword, setShowPassword] = useState(false);
    ...
    return (
      <TextField
        ...
        sx={{
          ...
          "& .MuiFormHelperText-root": { mt: 0.5, fontSize: "0.75rem" },
          ...sx,
        }}
        {...restOfProps} // Spread value, onChange, error, disabled, helperText, etc.
      />
    );
  }
);
